...
```
From this graph we can see that the month of July has the greatest amount of median duration throughout the weekdays, they are most significant around the weekend. Additionally, we can also see that the month of January has half the amount of median ride duration than July. This can possibly be due to the seasons, July is warmer and January is colder. Lastly, we can observe that the median rider duration is highest around the days Saturday and Sunday. 
...
Path worked the two graphs of 2020 and 2024 to compare differences in use of classic and electric bike among casual and member riders.
